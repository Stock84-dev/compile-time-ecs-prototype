...
use cust::DeviceCopy;
use memmap2::Mmap;
use mouse::{ext::StaticSize, helpers::ptr_as_slice, num::NumExt};
use rayon::prelude::*;
...
#[derive(Serialize, Deserialize, Pod, Zeroable, Clone, Copy)]
#[repr(C)]
// Do not change, data is stored on HDD.
pub struct OrderFlowTick2 {
...
#[repr(C)]
#[derive(
    Serialize, Deserialize, Readable, Writable, PartialEq, Debug, Clone, Default, DeviceCopy, Copy,
)]
pub struct Hlcv {
    pub high: f32,
    pub low: f32,
