...
use nebuchadnezzar_core::{
    ...
    client::ring::hmac,
    error::Result,
    futures_util::{stream::Fuse, FutureExt, StreamExt},
    prelude::Utc,
    reqwest::{Method, Url},
    serde_json,
    signatures::hmac_sha256,
    tokio::net::TcpStream,
    websocket::{
        tokio_tungstenite::{
            connect_async, tungstenite::Message as RawMessage, MaybeTlsStream, WebSocketStream,
        },
        WebSocket, WebSocketCapability, WsCommand,
    },
...
use crate::{
    client::Credential, error::BitmexWsError, exchange::Bitmex,
    nebuchadnezzar_core::futures_util::SinkExt,
};
