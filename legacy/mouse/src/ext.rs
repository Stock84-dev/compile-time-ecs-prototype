...
use tokio::{pin, runtime::Handle, task::JoinHandle};

use crate::{
    error, helpers,
    helpers::{ptr_as_slice, ptr_as_slice_mut},
    macros::tokio::io::AsyncSeekExt,
    prelude::*,
};
...
impl<T> IdName for T {
    ...
    fn struct_name() -> &'static str {
        ...
        return name;
        // TODO: if type name is 'a::b<c::d>' then it doesn't work
